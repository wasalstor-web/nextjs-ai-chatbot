...
export default function AdminFilesPage() {
  ...
  return (
    <div className="flex flex-col gap-4 p-6">
      <div>
        <h1 className="font-bold text-3xl">إدارة الملفات</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-lg border p-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-sm">التخزين</span>
          </div>
        ...
        <div className="rounded-lg border p-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-sm">الرفع</span>
          </div>
          <p className="mt-1 text-muted-foreground text-sm">
        ...
        <div className="flex items-start gap-3 rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-800 dark:bg-yellow-950">
          ...
          <div>
            ...
            <p className="text-xs text-yellow-700 dark:text-yellow-300">
              لتفعيل رفع الملفات، قم بتفعيل Cloudflare R2 وأضف المتغيرات البيئية
              المطلوبة
            </p>
          </div>
        </div>
