...
import { Bot, Search, Filter, Plus, Edit, Trash2, Eye, MoreVertical } from "lucide-react";
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">إدارة الوكلاء</h2>
          <p className="text-muted-foreground">
            إدارة جميع الوكلاء في النظام
          </p>
        </div>
        <Button>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {filteredAgents.length} وكيل موجود
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                {filteredAgents.length === 0 ? (
                  ...
                  filteredAgents.map((agent) => (
                    <TableRow key={agent.id}>
                      ...
                      <TableCell>{agent.usageCount?.toLocaleString() || 0}</TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <Badge variant="outline">{agent.source || "mubasat"}</Badge>
                      </TableCell>
                      <TableCell>
                        <DropdownMenu>
