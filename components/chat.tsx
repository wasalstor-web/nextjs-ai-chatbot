  ...
  return (
    <>
      <div className="overscroll-behavior-contain flex h-dvh min-w-0 touch-pan-y flex-col bg-background">
        ...
        <div className="sticky bottom-0 z-1 mx-auto flex w-full max-w-3xl gap-2 bg-linear-to-t from-background via-background to-background/0 px-3 pt-2 pb-4 md:px-4 md:pb-5">
          {!isReadonly && (
            <MultimodalInput
